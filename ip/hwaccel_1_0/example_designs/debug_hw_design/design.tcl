...
proc create_ipi_design { offsetfile design_name } {
	...
	# Connect all clock & reset of hwaccel_0 slave interfaces..
	connect_bd_intf_net [get_bd_intf_pins axi_peri_interconnect/M00_AXI] [get_bd_intf_pins hwaccel_0/axi_lite]
	connect_bd_net [get_bd_pins hwaccel_0/axi_lite_aclk] [get_bd_pins sys_clk_0/clk_out1]
	connect_bd_net [get_bd_pins hwaccel_0/axi_lite_aresetn] [get_bd_pins sys_reset_0/peripheral_aresetn]

	# Connect all clock, reset & status pins of hwaccel_0 master interfaces..
	connect_bd_intf_net [get_bd_intf_pins axi_mem_interconnect/S00_AXI] [get_bd_intf_pins hwaccel_0/axim_in]
	connect_bd_net [get_bd_pins hwaccel_0/axim_in_aclk] [get_bd_pins sys_clk_0/clk_out1]
	connect_bd_net [get_bd_pins hwaccel_0/axim_in_aresetn] [get_bd_pins sys_reset_0/peripheral_aresetn]
	connect_bd_net [get_bd_pins hwaccel_0/axim_in_txn_done] [get_bd_pins xlconcat_0/In0]
	connect_bd_net [get_bd_pins hwaccel_0/axim_in_error] [get_bd_pins xlconcat_0/In1]
	connect_bd_net [get_bd_pins hwaccel_0/axim_in_init_axi_txn] [ get_bd_pins slice_block/Dout0 ]
	connect_bd_intf_net [get_bd_intf_pins axi_mem_interconnect/S01_AXI] [get_bd_intf_pins hwaccel_0/axim_out]
	connect_bd_net [get_bd_pins hwaccel_0/axim_out_aclk] [get_bd_pins sys_clk_0/clk_out1]
	connect_bd_net [get_bd_pins hwaccel_0/axim_out_aresetn] [get_bd_pins sys_reset_0/peripheral_aresetn]
	connect_bd_net [get_bd_pins hwaccel_0/axim_out_txn_done] [get_bd_pins xlconcat_0/In2]
	connect_bd_net [get_bd_pins hwaccel_0/axim_out_error] [get_bd_pins xlconcat_0/In3]
	connect_bd_net [get_bd_pins hwaccel_0/axim_out_init_axi_txn] [ get_bd_pins slice_block/Dout1 ]


	# Auto assign address
	assign_bd_address

	# Configure address param & range of hwaccel_0 master interfaces..
	set_property range 16K [get_bd_addr_segs {jtag_axi_0/Data/SEG_axi_bram_ctrl_0_Mem0}]
	set_property range 16K [get_bd_addr_segs {hwaccel_0/axim_in/SEG_axi_bram_ctrl_0_Mem0}]
	set_property range 16K [get_bd_addr_segs {hwaccel_0/axim_out/SEG_axi_bram_ctrl_0_Mem0}]
	set_property -dict [list  CONFIG.C_axim_in_TARGET_SLAVE_BASE_ADDR {0xC0000000} CONFIG.C_axim_out_TARGET_SLAVE_BASE_ADDR {0xC0000100} ] [get_bd_cells hwaccel_0]

	# Copy all address to hwaccel_include.tcl file
	set bd_path [get_property DIRECTORY [current_project]]/[current_project].srcs/[current_fileset]/bd
	upvar 1 $offsetfile offset_file
	set offset_file "${bd_path}/hwaccel_include.tcl"
	...
	set offset [get_property OFFSET [get_bd_addr_segs /jtag_axi_0/Data/SEG_hwaccel_0_axi_lite_* ]]
	puts $fp "set axi_lite_addr ${offset}"
...
set hw_test_file ${ip_path}/example_designs/debug_hw_design/hwaccel_hw_test.tcl
