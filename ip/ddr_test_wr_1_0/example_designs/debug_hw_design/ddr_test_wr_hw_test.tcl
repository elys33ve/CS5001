# Runtime Tcl commands to interact with - ddr_test_wr

# Sourcing design address info tcl
set bd_path [get_property DIRECTORY [current_project]]/[current_project].srcs/[current_fileset]/bd
source ${bd_path}/ddr_test_wr_include.tcl
...
# Test: axim
set wdata_axim [get_init_data 0]
create_hw_axi_txn w_axim_addr [get_hw_axis $jtag_axi_master] -type write -address $axi_gpio_out_addr -data ${wdata_axim}
create_hw_axi_txn r_axim_addr [get_hw_axis $jtag_axi_master] -type read -address $axi_gpio_in_addr 
# Initiate transactions
run_hw_axi r_axim_addr
run_hw_axi w_axim_addr
run_hw_axi r_axim_addr
set rdata_tmp [get_property DATA [get_hw_axi_txn r_axim_addr]]
set DE [ get_done_and_error_bit $rdata_tmp 1 0 ]
# Compare read data
if { $DE == 01 } {
	puts "Data comparison test pass for - axim"
} else {
	puts "Data comparison test fail for - axim, rdata-$rdata_tmp expected-01 actual-$DE"
	inc ec
}
