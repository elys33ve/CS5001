...
proc create_ipi_design { offsetfile design_name } {
	...
	# Create instance: ddr_test_rd_0, and set properties
	set ddr_test_rd_0 [ create_bd_cell -type ip -vlnv user.org:user:ddr_test_rd:1.0 ddr_test_rd_0 ]
	...
	# Connect all clock & reset of ddr_test_rd_0 slave interfaces..
	connect_bd_intf_net [get_bd_intf_pins axi_peri_interconnect/M00_AXI] [get_bd_intf_pins ddr_test_rd_0/axi_lite]
	connect_bd_net [get_bd_pins ddr_test_rd_0/axi_lite_aclk] [get_bd_pins sys_clk_0/clk_out1]
	connect_bd_net [get_bd_pins ddr_test_rd_0/axi_lite_aresetn] [get_bd_pins sys_reset_0/peripheral_aresetn]

	# Connect all clock, reset & status pins of ddr_test_rd_0 master interfaces..
	connect_bd_intf_net [get_bd_intf_pins axi_mem_interconnect/S00_AXI] [get_bd_intf_pins ddr_test_rd_0/axim]
	connect_bd_net [get_bd_pins ddr_test_rd_0/axim_aclk] [get_bd_pins sys_clk_0/clk_out1]
	connect_bd_net [get_bd_pins ddr_test_rd_0/axim_aresetn] [get_bd_pins sys_reset_0/peripheral_aresetn]
	connect_bd_net [get_bd_pins ddr_test_rd_0/axim_txn_done] [get_bd_pins xlconcat_0/In0]
	connect_bd_net [get_bd_pins ddr_test_rd_0/axim_error] [get_bd_pins xlconcat_0/In1]
	connect_bd_net [get_bd_pins ddr_test_rd_0/axim_init_axi_txn] [ get_bd_pins axi_gpio_out/gpio_io_o ]


	# Auto assign address
	assign_bd_address

	# Configure address param & range of ddr_test_rd_0 master interfaces..
	set_property range 16K [get_bd_addr_segs {jtag_axi_0/Data/SEG_axi_bram_ctrl_0_Mem0}]
	set_property range 16K [get_bd_addr_segs {ddr_test_rd_0/axim/SEG_axi_bram_ctrl_0_Mem0}]
	set_property -dict [list  CONFIG.C_axim_TARGET_SLAVE_BASE_ADDR {0xC0000000} ] [get_bd_cells ddr_test_rd_0]

	# Copy all address to ddr_test_rd_include.tcl file
	set bd_path [get_property DIRECTORY [current_project]]/[current_project].srcs/[current_fileset]/bd
	upvar 1 $offsetfile offset_file
	set offset_file "${bd_path}/ddr_test_rd_include.tcl"
	...
	set offset [get_property OFFSET [get_bd_addr_segs /jtag_axi_0/Data/SEG_ddr_test_rd_0_axi_lite_* ]]
...
set ip_path [file dirname [file normalize [get_property XML_FILE_NAME [ipx::get_cores user.org:user:ddr_test_rd:1.0]]]]
set hw_test_file ${ip_path}/example_designs/debug_hw_design/ddr_test_rd_hw_test.tcl
...
for { set i 1 } { 1 } { incr i } {
	set design_name "ddr_test_rd_hw_${i}"
